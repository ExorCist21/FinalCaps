            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('patients.dashboard')" :active="request()->routeIs('therapist.dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>

                        <!-- Add more therapist-specific links here -->
                        <x-nav-link :href="route('patients.appointment')" :active="request()->routeIs('therapist.appointment')">
                            {{ __('Appointment') }}
                        </x-nav-link>
    ...
    <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <div class="relative">
                        <i class="fa-regular fa-bell font-semibold text-gray-500 hover:text-green-500 cursor-pointer"></i>
